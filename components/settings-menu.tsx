        ...
        <div className="bg-yellow-300 p-6 rounded-none border-4 border-black shadow-lg relative">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-8 p-4 bg-white/20 rounded-none border-4 border-black">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <Label className="text-lg font-semibold text-gray-800">Music</Label>
                  <p className="text-sm text-gray-600">Enable or disable background music</p>
                </div>
                <Switch
              ...
              <div className="space-y-4">
                <div className="space-y-1">
                  <Label className="text-lg font-semibold text-gray-800">Volume</Label>
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <span className="min-w-[3ch] text-gray-800 font-mono">{musicVolume}</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1 mt-6 p-3 bg-black/20 rounded border-2 border-black">
              ...
              >
                "Tetoris (AI Filtered Instrumental)" by Jared-KunYT
              </a>
            </div>
